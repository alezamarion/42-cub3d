...
/*   Updated: 2022/11/16 11:08:51 by joeduard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		{
// 			if (game->img.data[(WINDOW_WIDTH * y) + i] == game->rays[i].was_hit_vertical)
// 				game->img.data[(WINDOW_WIDTH * y) + i] = 0xFFFFFFFF;
// 			else
// 				game->img.data[(WINDOW_WIDTH * y) + i] = 0xFFCCCCCC;
// 			y++;
// 		}
// 		i++;
// 	}
