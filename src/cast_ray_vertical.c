...
/*   Updated: 2022/11/16 22:36:47 by azamario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//    ray_angle = normalize_angle_cast_ray(ray_angle);
    ...
    while (next_vertical_touch_x >= 0 && next_vertical_touch_x <= WINDOW_WIDTH && next_vert_touch_y >= 0 && next_vert_touch_y <= WINDOW_HEIGHT) {
