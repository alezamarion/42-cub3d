...
/*   Updated: 2022/11/16 22:25:02 by azamario         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//    ray_angle = normalize_angle_cast_ray(ray_angle);
    ...
    while (next_horiz_touch_x >= 0 && next_horiz_touch_x <= WINDOW_WIDTH && next_horiz_touch_y >= 0 && next_horiz_touch_y <= WINDOW_HEIGHT) {
